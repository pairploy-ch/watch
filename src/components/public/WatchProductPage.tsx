...
const FilterSidebar: React.FC = () => {
  ...
  return (
    <div >
      <h2 className="text-white text-xl mb-4" style={{fontWeight: '400'}}>Search Filters</h2>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {brands.map(brand => (
              <label key={brand} className="flex items-center space-x-3 cursor-pointer hover:bg-gray-800 p-2 rounded">
                <input
                  type="checkbox"
      ...
      <button className="w-full primary-btn-md mt-7">
        APPLY FILTER
      </button>
      </div>
